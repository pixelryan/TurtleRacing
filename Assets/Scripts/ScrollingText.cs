...
// ************************************************************************ 
// http://jiyambi.blogspot.com/2014/03/unity-tutorial-scrolling-ticker-text.html
// "Feel free to use it directly or as a model for your own creations."
...
public class ScrollingText : MonoBehaviour {
	...
	void Update () {
        ...
        if (m_textMesh.textBounds.max.x < m_scissorMin)
		{
			UseNextMessage();
		}
	}
	...
	private void UseNextMessage()
	{
		...
		float width =   m_textMesh.textBounds.max.x 
					  - m_textMesh.textBounds.min.x;
